...
export const runPerformanceCheck = async ({ uri, db, userId, createdAt, quickcheckId }) => {
  ...
  await createCheckResult({ db, userId, createdAt, check: 'performance', result, quickcheckId })
}
