...
export const runPerformanceCheck = async ({ uri, db, websiteId, createdAt, quickcheckId }) => {
  ...
  await createCheckResult({ db, websiteId, createdAt, check: 'performance', result, quickcheckId })
}
