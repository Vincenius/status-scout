...
export const runPerformanceCheck = async ({ uri, id, websiteId, createdAt, quickcheckId }) => {
  ...
  await createCheckResult({ id, websiteId, createdAt, check: 'performance', result, quickcheckId })
}
