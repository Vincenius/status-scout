...
export const runHeaderCheck = async ({ uri, id, websiteId, createdAt, quickcheckId }) => {
  ...
  try {
    ...
    await createCheckResult({ id, websiteId, createdAt, check: 'headers', result, quickcheckId })
  } catch (err) {
