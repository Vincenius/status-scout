...
export const runSslCheck = async ({ uri, id, websiteId, createdAt, quickcheckId, type }) => {
  ...
  await createCheckResult({ id, websiteId, createdAt, check: 'ssl', result, quickcheckId, type })
}
